  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="bg-card/60 border-t border-coral/20 py-4 px-5 text-center text-xs text-text-secondary">
        <p>あの人の裏の顔診断（ちょいゲスな悪趣味エンタメ）</p>
        <p className="mt-1 text-[0.7rem]">
          ※ 勝手に覗き見た結果です。本気にしないでね。
        </p>
        <div className="mt-2 flex justify-center gap-4 text-[0.7rem]">
          <Link to="/legal" className="text-text-secondary hover:text-vivid-pink transition-colors no-underline">
            特定商取引法に基づく表記
          </Link>
          <Link to="/privacy" className="text-text-secondary hover:text-vivid-pink transition-colors no-underline">
            プライバシーポリシー
          </Link>
        </div>
      </footer>
