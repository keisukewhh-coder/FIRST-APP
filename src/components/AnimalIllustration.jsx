...
function NightCat() {
  return (
    <svg viewBox="0 0 200 200" width="180" height="180">
      ...
      {/* City skyline */}
      <rect x="20" y="130" width="16" height="50" rx="2" fill="#3D3560" />
      <rect x="40" y="115" width="12" height="65" rx="2" fill="#3D3560" />
      <rect x="56" y="125" width="18" height="55" rx="2" fill="#3D3560" />
      <rect x="130" y="120" width="14" height="60" rx="2" fill="#3D3560" />
      <rect x="148" y="110" width="16" height="70" rx="2" fill="#3D3560" />
      <rect x="168" y="130" width="12" height="50" rx="2" fill="#3D3560" />
      {/* Stars */}
      <circle cx="30" cy="40" r="1.5" fill="#FFD700" opacity="0.7" />
      <circle cx="85" cy="30" r="1" fill="#FFD700" opacity="0.5" />
...
function AlleyChihuahua() {
  return (
    <svg viewBox="0 0 200 200" width="180" height="180">
      ...
      {/* Star accessory */}
      <polygon points="100,48 102,54 108,54 103,58 105,64 100,60 95,64 97,58 92,54 98,54" fill="#FFD700" />
    </svg>
  );
}
...
function ChargingLion() {
  return (
    <svg viewBox="0 0 200 200" width="180" height="180">
      ...
      {/* Tie */}
      <polygon points="97,118 103,118 101,145 100,148 99,145" fill="#C0392B" />
      {/* Mane */}
      <circle cx="100" cy="78" r="42" fill="#D4A03C" />
...
function StrategyPenguin() {
  return (
    <svg viewBox="0 0 200 200" width="180" height="180">
      <circle cx="100" cy="100" r="95" fill="#B8D4E8" />
      {/* Station platform */}
...
function ShelterRabbit() {
  return (
    <svg viewBox="0 0 200 200" width="180" height="180">
      <circle cx="100" cy="100" r="95" fill="#E8D5E8" />
      {/* Cherry blossom tree */}
      ...
      {/* Falling petals */}
      <ellipse cx="120" cy="45" rx="3" ry="2" fill="#FFB6C1" opacity="0.6" transform="rotate(30,120,45)" />
      <ellipse cx="50" cy="60" rx="3" ry="2" fill="#FFB6C1" opacity="0.5" transform="rotate(-20,50,60)" />
      <ellipse cx="80" cy="35" rx="2" ry="1.5" fill="#FFB6C1" opacity="0.4" transform="rotate(45,80,35)" />
      {/* Body */}
...
function CraftsmanWolf() {
  return (
    <svg viewBox="0 0 200 200" width="180" height="180">
      <circle cx="100" cy="100" r="95" fill="#4A4A5A" />
      {/* Workshop background */}
      <rect x="15" y="140" width="170" height="40" rx="2" fill="#3A3A4A" />
      {/* Tools on wall */}
      ...
      <g transform="translate(140,130)">
        ...
        <rect x="2" y="7" width="20" height="12" rx="1" fill="#7AC" />
        <rect x="-2" y="21" width="28" height="2" rx="1" fill="#666" />
      </g>
    </svg>
  );
}
...
function FestivalPanda() {
  return (
    <svg viewBox="0 0 200 200" width="180" height="180">
      <circle cx="100" cy="100" r="95" fill="#FFE4E1" />
      {/* Festival lanterns */}
      <line x1="20" y1="20" x2="180" y2="20" stroke="#FF6B6B" strokeWidth="1.5" />
      <g transform="translate(40,20)">
        <rect x="-6" y="0" width="12" height="16" rx="6" fill="#FF4444" opacity="0.7" />
